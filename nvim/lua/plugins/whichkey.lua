return {
  ...
  opts = {
    ...
    spec = {
      ...
      { '<leader>xd', ':Trouble diagnostics toggle filter.buf=0 <cr>', desc = 'document', nowait = true, remap = false },
      { '<leader>xl', ':Trouble loclist toggle <cr>', desc = 'loclist', nowait = true, remap = false },
      { '<leader>xq', ':Trouble qflist toggle <cr>', desc = 'quickfix', nowait = true, remap = false },
      { '<leader>xr', ':Trouble lsp toggle focus=false win.position=right <cr>', desc = 'references', nowait = true, remap = false },
      { '<leader>xx', ':Trouble diagnostics toggle <cr>', desc = 'trouble', nowait = true, remap = false },
      { '<leader>k', ':lua require("kubectl").toggle()<cr>', desc = 'kubectl', noremap = true, silent = true },
    },
  },
